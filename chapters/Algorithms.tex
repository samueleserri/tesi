...
\begin{algorithm}[H]\label{NNDSVD}
...
\section*{}
During the last decades, many algorithm have been proposed to solve the NMF problem, in this chapter we derived and presented the most important ones.
There are different variant of the algorithm presented here, notably some algorithm can be accelerated.
\cite{gillis2012accelerated}.