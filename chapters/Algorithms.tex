...
The algorithms are listed here: multiplicative updates (MU) with the Frobenius norm (Algorithm \ref{MU for Frobenius}), with the Kullback-Leibler divergence (Algorithm \ref{MU for KL}) and with the $\beta$-divergence (Algorithm \ref{MU for beta}); alternating non-negative least squares (ANLS) (Algorithm \ref{ANLS}); alternating least squares (ALS) (Algorithm \ref{ALS}); projected gradient descent (PGD) (Algorithm \ref{Projected Gradient}); hierarchical alternating least squares (HALS) (Algorithm \ref{HALS}).
\par
