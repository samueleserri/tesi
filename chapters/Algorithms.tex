...
Since this is a gradient descent method with a Lipschitz step size with a projection onto a the non-negative orthant when the iterates go out of bounds,
