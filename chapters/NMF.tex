...
Their results are also reproduced in this thesis in subsection \ref{Example feature extraction NMF} to show a prominent example of NMF's application.
...
In the same paper, Vavasis also showed that a polynomial-time local search heuristic exists. In the next chapter we will see the most important algorithms to undertake the NMF problem, and it will be clear that they come with no global (?) guarantees.
