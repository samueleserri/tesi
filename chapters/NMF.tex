...
The reason for this is that because it is easier to visualize and because there is a close connection between the NMF and a problem in computational geometry known as the and the nested polytope problem (NPP)  \cite{donoho2003does}.
