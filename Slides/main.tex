...
\begin{frame}{Make Titles Informative.}
  ...
  \begin{frame}{Example: learning parts of objects with NMF \cite{lee1999}}
    \begin{columns}
      \column{0.5\textwidth}
      \begin{figure}
...
\begin{frame}{Make Titles Informative.}
Can be interpreted as a scaled \alert{gradient descent} method:
...
\begin{frame}{The Algorithms have been implemenetd in Python}
  %% Repo link: \url{https://github.com/samueleserri/NMF.git}

  \begin{columns}
    \column{0.55\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{../Imgs/Chapter 5/CBCL_random_init.png}
      \caption{CBCL dataset:}
    \end{figure}
    
    \column{0.5\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{../Imgs/Chapter 5/Top30_news_random_init.png}
      \caption{TDT2 dataset:}
    \end{figure}
  \end{columns}
  Dense case: fastest HALS
  SParse case: fastest MU
\end{frame}
